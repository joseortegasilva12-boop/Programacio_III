...
namespace app_inventario.views
{
    partial class FormSalidas
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblTitulo.Text = "📤  Salidas de Stock";
            ...
            this.lblSub.Text = "Registrar salida con validación de stock disponible";
            this.lblSub.Font = new Font("Segoe UI", 8F);
            this.lblSub.ForeColor = Color.FromArgb(255, 210, 210);
            ...
            this.cmbProducto.SelectedIndexChanged +=
                new System.EventHandler(this.cmbProducto_SelectedIndexChanged);
            ...
            this.txtObs.PlaceholderText = "Ej: Venta cliente";
            ...
            // Label stock info
            this.lblStockInfo.Text = "Selecciona un videojuego para ver el stock";
            this.lblStockInfo.Font = new Font("Segoe UI", 8.5F, FontStyle.Italic);
            this.lblStockInfo.ForeColor = Color.Gray;
            this.lblStockInfo.Dock = DockStyle.Top;
            this.lblStockInfo.Height = 30;
            this.lblStockInfo.TextAlign = ContentAlignment.MiddleLeft;
            this.lblStockInfo.Padding = new Padding(6, 0, 0, 0);
            ...
            this.btnRegistrar.BackColor = Color.FromArgb(192, 57, 43);
            ...
            this.dgv.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(192, 57, 43);
            ...
            this.dgv.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(255, 245, 245);
            ...
            // StatusStrip
            this.lblStatus.Text = "Salidas registradas: 0";
        ...
        private Label lblTitulo, lblSub, lblProd, lblCant, lblObs, lblStockInfo;
